...
//  Project23
//
//  Created by Ashraf Dewan on 3/23/20.
...
class GameScene: SKScene {
    ...
    let enemyXVelocityRange: [(CGFloat, ClosedRange<Int>)] = [
        (maxXPosition: 256,range: 8...15),
        (maxXPosition: 512,range: 3...5),
        (maxXPosition: 768,range: -5...(-3)),
        (maxXPosition: 1024,range: -15...(-8))
    ]
    ...
    func createEnemy(forceBomb: ForceBomb = .random) {
        ...
        for (maxXPosition, range) in enemyXVelocityRange {
            if randomPosition.x < maxXPosition {
        ...
        //2
        let multiplier = enemyType == 7 ? 60 : 40
