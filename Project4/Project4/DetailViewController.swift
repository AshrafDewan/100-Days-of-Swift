...
class DetailViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        let back = UIBarButtonItem(barButtonSystemItem: .action, target: webView, action: #selector(webView.goBack))
        let forward = UIBarButtonItem(barButtonSystemItem: .action, target: webView, action: #selector(webView.goForward))
